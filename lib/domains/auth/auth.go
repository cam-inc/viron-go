...
type Auth struct {
	...
	authGoogleOAuth2Config *configs.GoogleOAuth2
	authGoogleOAuth2       *AuthOIDC
	authOIDCConfig         *configs.OIDC
	authOIDC               *AuthOIDC
}

// New Auth初期化
func New(multipleAuthUser *bool, google *configs.GoogleOAuth2, oidcConfig *configs.OIDC, providerFactory OIDCProviderFactory) *Auth {
